    ...
    return (
        <div id="auth_page">
            ...
            <form name="login" className="form" onSubmit={(e) => e.preventDefault()}>
                ...
                <MyButton onClick={submit}>Зарегистрироваться</MyButton>
            </form>

            <div className="footer">
                <span className="register__title">Уже есть аккаунт?</span>
                <Link to="/login" className="register__button">Войди</Link>
            </div>
        </div>
    )
}